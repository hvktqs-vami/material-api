...
{
    public abstract class VamiWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static VamiWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(VamiWebMvcModule).Assembly.FullName);
        }
        ...
        protected void UsingDbContext(Action<VamiDbContext> action)
        {
            using (var context = IocManager.Resolve<VamiDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected T UsingDbContext<T>(Func<VamiDbContext, T> func)
        {
            T result;
        ...
        protected async Task UsingDbContextAsync(Func<VamiDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<VamiDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<VamiDbContext, Task<T>> func)
        {
            T result;
