...
namespace Mta.Vami.WebApi.Core
{
    ...
    public class UnitDataSourceCollection : List<UnitDatasource>
    {
        public UnitDataSourceCollection() : base()
        {
        ...
        public bool AddIfNotExist(UnitDatasource item)
        {
        ...
        public UnitDatasource this[string name]
        {
            get
            {
